...
# xây dựng một bộ nạp và tiền xử lý dữ liệu hiệu năng cao (Data Generator)
# bằng cách sử dụng thư viện NVIDIA DALI (Data Loading and Augmentation Library) kết hợp với TensorFlow.
